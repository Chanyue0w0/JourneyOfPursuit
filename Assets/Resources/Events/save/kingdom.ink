...
/////////////////////////////////////////////////////////////////////
#portrait:Node1_Born/alley #bgm:forest
你醒來時，發現自己躺在一個狹窄陰暗的小巷弄裡，”這裡是……?”你感到一陣混亂。緩慢起身，晃了晃腦袋，試圖理清現在的情況。”我剛剛應該在......等等，我原本在哪裡?”你嘗試回想，卻一無所獲。
+[檢視自身] #bgm:stop
你穿的衣服沾滿了黑灰，邊角還有些燒焦的痕跡。從口袋裡翻出了一條項鍊。正中心鑲著一顆紅寶石，看起來價值不斐。<br>你對它的存在感到困惑，卻莫名地對它有著熟悉感，似是並非第一次看到它。#portrait:Node1_Born/necklace#music:never#bgm:go
++[戴起項鍊]
你將項鍊戴起，開始打量起四周。#music:stop
+++[探索巷子] #music:go
    ->alley_random1
...
+[翻開]
    你發現了金幣。#money:20 #portrait:Node1_Born/coins
    ++[繼續探索]
    ->in_alley
    ++[離開巷子]
    ->first_guy
...
===first_guy===
出了巷子，你看到一個人坐在箱子上休息，看起來是搬箱子的工人。#portrait:Node1_2FirstGuy/guy_on_box
...
===notice===
    ...
    *[公告三]
        ...
        ->notice
    *[公告四]
        "尋寵啟示"<br> “我家的萊斯走丟了！在城門附近走失，請有發現人一定要通知我！拜託拜託！一定獻上最高的謝意給找到牠的好心人！”//#portrait:Event1_Notice/dog_photo
...
===event1_find===
“汪汪”，幾聲狗叫聲傳來，你快步上前。一隻大灰狗趴伏在地上，雖然跟刊登紙上的顏色不符，但脖子上的那顆綠寶石確實跟單子上的一模一樣。//#portrait:Event1_Notice/dog
...
+[替他買一杯飲料(5coins)]
    #money: -5
    你決定替他買一杯冰涼的飲料，緩解疲勞。恰好一旁有一攤賣飲料的攤販，你向小販買了一杯亮黃色的奇妙飲品，上頭還不斷冒著氣泡。#portrait:Event2_Guard/drink_y
...
===event3===
~ Times = Times + 1
你來到了酒吧。#portrait:Event3_Bar/bar
->bar
===bar===
酒吧喧嘩震天。
*[坐在角落]
    你找了個人少的角落坐下。耳朵不經意地捕捉到了一個關於「許願石」的傳說，正好是一群當地居民在聊天中提到的。他感到這個話題非常引人注目，並開始仔細傾聽。
    ...
    ->bar
*[坐在吧檯]
    我走到吧檯，找了個位子坐下。調酒師熟練的調起了酒。”新面孔?今天想來點什麼?”他友好的向我搭話。#portrait:Event3_Bar/bartender
    "唉，我也是一肚子疑惑，”你嘆了口氣，”一醒來，發現自己躺在無人的巷子，失去了所有的記憶，發現身上只有個神祕的項鍊……。”<br>興許是酒吧的氣氛所致，你向他分享起了我的茫然。
    他聽完了你的故事，沉思了一會兒。
    ~temp res = DiceResult(21, "charisma")
    #rolling:0
    {res:
        調酒師注視著你，點了點頭，說道："我明白你的感受，朋友。有時生活的困難會讓我們感到無助。這杯飲料是送給你的，希望它能為你帶來一些安慰。不要擔心，我們都曾經需要幫助，這個酒吧是一個友善的地方。如果你需要聊天或者更多的幫助，我們都在這裡。"
        你接過了那杯飲料，感到一股溫暖和希望，”我並不孤單”，這個酒吧成了你在這個陌生城市尋找自我的地方。
    - else:
        調酒師卻沒有表現出同情，他皺起了眉頭，看起來有些猶豫。似是不相信你的言語。
        "我為你的經歷感到遺憾，也許你只是昨晚喝的比較多，所以才會在巷子中醒來。"他了一杯水。
        ”喝點水，醒醒酒吧。”
...
===event4===
~ Times = Times + 1
一人靠坐在廣場中央的雕像旁，他談著豎琴，風精靈在他身周隨著歌聲起舞。//#portrait:Event4_Poet/poet
...
街頭藝人的表演充滿驚奇和魔法元素，他不斷讓觀眾驚喜不斷，他的技巧和魔法能力令人嘆為觀止。他在整個表演中娛樂著觀眾，將這個奇幻世界的魔法之美呈現給每一位在場的人。这個奇妙的瞬間讓你感到這個世界的魔法和奇幻之處。#portrait:Event9_Actor/magician
->street
...
===event11_buy===
(選擇購買哪個)
    *[珠寶(price: 60coins)]#portrait:Event11_Vendor/germ
        ++[殺價(price -10 coins)]   
            你順著老闆的話，“老闆你看，我是外地來的，而且又是第一次光臨你們店，能不能給點折扣啊！”
            ~temp res = DiceResult(25, "charisma")
            #rolling:2
            {res:
                “當然沒問題!"老闆大氣的擺了擺手，”別說我對你不好，就算你9折吧！”#money: -50
                你成功買到了寶石。
                ->event11_buy
            -else:
...
+[同意]
    ...
    謹慎地取下項鍊，將它交給了龍人珠寶商。他滿意地接過項鍊，環顧四周，似乎對這筆交易感到滿意。<br>龍人珠寶商表示感謝，說："這位貴客，你做出了明智的選擇。比起只能觀賞的寶石，還是金幣更適合你現在的處境。來吧，這裡是你的十萬金幣，去換一套新衣服吧。"
...
===Node2===
突然，一隊士兵騎著華麗的戰馬出現在街道上，他們穿著華麗的鎧甲，手舉繡有金色帝國標誌的大旗，彷彿在宣示著他們的權威。隨著士兵的到來，人群中掌聲和歡呼聲此起彼落，顯示出這是國王的巡街。#portrait:Node2_KingDemonstration/army_come
...
我繼續緊握著項鍊，心中充滿了疑惑和好奇。
隨著國王和公主的隊伍繼續前進，漸行漸遠，我留在原地，看著他們消失在遠方的街道上。我的心中充滿了疑問和好奇，這串紅寶石項鍊似乎是我的指引，但我不知道應該前往何處。#portrait:Node2_KingDemonstration/army_leave
->Node3

===Node3===
”感覺到好像有個視線一直看我。”你多次回頭，卻都沒有找到視線的來源。<br>觀看國王巡街的人群還未散去，你只能跟隨著人流移動。
突然，你感覺到有人抓住你的手，定睛一看，是一個披著長斗篷的少年。”自然點，跟著我，我能幫你甩掉跟蹤的人。”
“你是……?”你一臉疑惑。<br>“你被國王盯上了，現在他派人跟蹤你。不想被抓住的話就跟著我走。”
跟著他的步伐，你們離開了人流，到了一條小巷。#portrait:Node3_ToForest/helper
他脫下連帽，”這一屆的繼承人也真是的，連被跟蹤了都不知道。”他抱怨道，然後看著我。<br>“為什麼這一屆的繼承人會出現在這裡？”他語氣有些急促，且帶著些許責備。
